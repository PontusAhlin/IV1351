...
CREATE TABLE available_instructor (
 availiability_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
 instructor_id INT NOT NULL,
...
ALTER TABLE phone_number ADD CONSTRAINT PK_phone_number PRIMARY KEY (phone_number UNIQUE,contact_detail_id);
...
ALTER TABLE student ADD CONSTRAINT FK_student_1 FOREIGN KEY (sibling_id) REFERENCES student (id);
...
ADD CONSTRAINT FK_adress_lesson FOREIGN KEY (lesson_id) REFERENCES lesson (id),
ADD CONSTRAINT FK_adress_group_lesson FOREIGN KEY (group_lesson_id) REFERENCES group_lesson (id),
ADD CONSTRAINT FK_adress_ensemble FOREIGN KEY (ensemble_id) REFERENCES ensemble (id);
